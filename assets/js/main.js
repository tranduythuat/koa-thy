(() => {
  ...
  function initSwiper() {
    ...
    const lookbookSwiper = new Swiper('.lookbook-swiper', {
      ...
      loop: true,
      allowTouchMove: true,   // vẫn cho người dùng kéo tay để tương tác
      speed: 6000,            // thời gian di chuyển 1 vòng slide -> càng lớn càng chậm, mượt
      autoplay: {
        delay: 1,             // gần như 0 -> chạy liên tục, không dừng khựng
        disableOnInteraction: false,
        pauseOnMouseEnter: true, // dừng khi rê chuột vào, bỏ dòng này nếu không muốn
      },
    });
  }
